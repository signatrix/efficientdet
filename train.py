...
from src.coco_dataset import CocoDataset, Resizer, Normalizer, Augmenter, collater
    ...
    for epoch in range(opt.num_epochs):
        ...
        for iter, data in enumerate(training_generator):
            ...
            try:
                ...
                writer.add_scalar('Train/Classfication_loss', cls_loss, epoch * num_iter_per_epoch + iter)
        ...
        if epoch % opt.test_interval == 0:
            ...
            writer.add_scalar('Test/Classfication_loss', cls_loss, epoch)
